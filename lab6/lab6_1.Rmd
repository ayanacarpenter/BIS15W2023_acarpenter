...
NA is data that hasn't been collected. There are NAs in the summary when there are certain mammals who did not have information collected
```{r}
msleep %>% 
...
msleep %>% 
  ...
  select(order, genus, brainwt)
```
NA comes up because we did not measure the brain weight of the whales (Cetacea).
