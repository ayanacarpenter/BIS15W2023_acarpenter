...
In a data frame, the columns contain different classes of data but in a matrix all the elements are the same class of data. 

2. What is the command we use to import .csv files into R?  
name <- readr: : read_csv(" ") and remember to specify a path.
...
species, island, bill length in mm, bill depth in mm, flipper length in mm, body mass in grams, sex, and year. 
...
344 individuals were sampled across 3 islands. 168 on Biscoe island, 124 on  Dream island, and 52 on Torgersen. 
```{r}
